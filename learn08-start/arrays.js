function start() {
    ...
    // to do this we can use the concat, or we can create a new array week1 and to join with the week array
    // for example: const week1 = ["Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday"];
    // document.getElementById("week").innerHTML = week1.join(",");
    // this example will print: Saturday, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday
